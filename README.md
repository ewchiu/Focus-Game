...
This is an application for playing an abstract board game called Focus/Domination. You can see the rules [here](https://en.wikipedia.org/wiki/Focus_(board_game)).

This app is for the two-player version of the game.
...
The `FocusGame` class must include the following methods:
...
Here's a very simple example of how some output of running this game:
```
